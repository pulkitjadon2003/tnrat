...
export default function EditTeamPage() {
    ...
    const fetchTeam = async () => {
        try {
            setLoading(true);
            const res = await axios.get(`/api/team/get-team?id=${params.id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`/api/team/update-team?id=${params?.id}`, formData, {
                headers: {
            ...
            if (res.data?.status === true) {
                ...
                // Refresh team data to get updated logo URL if it was changed
                fetchTeam();
            }
        } catch (error) {
                ...
                <div className="bg-white shadow rounded-lg">
                    <div className="px-6 py-4 border-b border-gray-200">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Update team details and team members.
                        </p>
                    </div>
